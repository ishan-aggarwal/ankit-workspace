...
public class SaleTest {
    ...
    @Before
    public void setup() {
        Item item = new Item("Television", 200, 2, DiscountPolicy.MORE_THAN_ONE);
        sale.addItem(item);
    }
